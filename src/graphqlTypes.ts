...
export type AttributesConnectionResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["AttributesConnection"] = ResolversParentTypes["AttributesConnection"]
> = {
  attributes?: Resolver<
...
export type FolderConnectionResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["FolderConnection"] = ResolversParentTypes["FolderConnection"]
> = {
  items?: Resolver<
    Maybe<Array<ResolversTypes["String"]>>,
    ParentType,
...
> = {
  updateMetaData?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateMetaDataArgs, "id">
  >;
};
...
> = {
  getAttributes?: Resolver<
    Maybe<ResolversTypes["AttributesConnection"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetAttributesArgs, never>
  >;
  getMeta?: Resolver<
    Maybe<ResolversTypes["MetaData"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetMetaArgs, "id">
  >;
  getTags?: Resolver<
    Maybe<ResolversTypes["TagsConnection"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetTagsArgs, never>
  >;
  listFolder?: Resolver<
    Maybe<ResolversTypes["FolderConnection"]>,
    ParentType,
    ContextType,
    RequireFields<QueryListFolderArgs, "pageSize">
  >;
  search?: Resolver<
    Maybe<ResolversTypes["FolderConnection"]>,
    ParentType,
    ContextType,
    RequireFields<QuerySearchArgs, "pageSize" | "searchInput">
  >;
};
